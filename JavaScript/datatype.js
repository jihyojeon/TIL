...
console.log(Object.getOwnPropertyDescriptor(cat, 'name')); //(Obj, propertyname)
// {
//   value: 'Fluffy',
//   writable: true, <------ 여기 보세요
//   enumerable: true,
//   configurable: true
// }
...
// {
//   value: 'Fluffy',
//   writable: false, <-------- 여기보세요
//   enumerable: true,
//   configurable: true
// }
cat.name = 'Romeo';
console.log(cat.name); // Fluffy <-  정말 안 바뀌었다는 것을 확인할 수 있음.
// 이게 왜 필요하냐,,, arr.length를 reassign하는 방식으로 바꾸는 걸 생각해보셈... 혼돈의 세상이 올 듯

// 각종 완전 짜증나는 var 예시는 생략
// var 너무 싫어
